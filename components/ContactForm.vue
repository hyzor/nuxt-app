<template>
  <el-card class="card">
    <el-form ref="ruleForm" :model="contactForm" :rules="rules" label-width="0px">
      <el-form-item prop="name">
        <el-input v-model="contactForm.name" class="input" placeholder="Name"/>
      </el-form-item>
      <el-form-item prop="email">
        <el-input v-model="contactForm.email" class="input" placeholder="E-mail"/>
      </el-form-item>
      ...
      return {
        ...
        rules: {
          ...
          email: [
            ...
            { message: 'Please input a valid e-mail address', type: 'email', trigger: 'blur' }
          ],
          message: [
